            ...
            <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Social<span className='text-blue-500'>Post</span></span>
                    </a>
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <div className='flex justify-center items-center cursor-pointer'>
                            <div className='relative group'>
                                <div className='mr-16 text-2xl'>
                                    <RiAccountCircleLine />
                                </div>
                                <div className='absolute left-0 mt-1 w-50 bg-white rounded-lg shadow-lg transform opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 z-30 pointer-events-none group-hover:pointer-events-auto px-6 py-4'>
                                    <a href="#" className='block px-4 py-2 text-gray-700 hover:bg-gray-100'>Profile</a>
                                    <a onClick={(e)=>navigate("/signin")}  className='block px-4 py-2 text-gray-700 hover:bg-gray-100'>Sign In</a>
                                    <a onClick={(e)=>navigate("/")}  className='block px-4 py-2 text-gray-700 hover:bg-gray-100'>Sign Up</a>
                                </div>
                            </div>
                        </div>
                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={(e) => navigate("/addpost")}>Add Post</button>
